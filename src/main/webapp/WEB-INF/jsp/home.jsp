...
<html>
    ...
    <body>
        <div class="site-wrap">
                                        ...
                                        <div class="container">
                                            ...
                                            <ul class="site-menu js-clone-nav d-none d-lg-block">
                                                ...
                                                <c:if test="${not empty booking}">
                                                    ...
                                                    <li><a href="<c:url value="/view_order" />">Booking Cart</a></li>
                                                    </c:if>
                            ...
                            <div class="col-md-6 col-lg-4 mb-5">
                                <div class="hotel-room text-center">
                                    ...
                                    <div class="hotel-room-body">
                                        ...
                                        <p><span class="badge badge-danger">${category.promotionEntities[0].discount}%</span> <span class="text-monospace text-danger" style="font-size:130%;"><fmt:formatDate pattern="dd/MM/yyyy" value="${category.promotionEntities[0].startDate}"/></span> To <span class="text-monospace text-danger" style="font-size:130%;"><fmt:formatDate pattern="dd/MM/yyyy" value="${category.promotionEntities[0].endDate}"/></span></p>
                                    </div>
                                </div>
                            </div>
                        </c:forEach>
            ...
            <!--                    Promotion-->
            <div class="py-5 upcoming-events" style="background-image: url('<s:url value="/resources/images/hero_1.jpg"/>'); background-attachment: fixed;">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <c:if test="${not empty promotion}"> <h2 class="text-white">${promotion.name} ${promotion.discount} % Off</h2></c:if>
                                <a href="#" class="text-white btn btn-outline-warning rounded-0 text-uppercase">Avail Now</a>
                            </div>
                            <div class="col-md-6">
                            <c:if test="${not empty promotion}"><span class="caption">The Promo will start in : <fmt:formatDate pattern="dd/MM/yyyy" value="${promotion.startDate}"/> To <fmt:formatDate pattern="dd/MM/yyyy" value="${promotion.endDate}"/> </span></c:if>
